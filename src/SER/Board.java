...
public void checkFoodCollisions() {
    ...
    if ((proximity(snake.getsnakeX(0), food.getFoodX(), 20))
        ...
        //realiza una comparacion en x e y para ver si coincide con la cabeza
        //de la serpiente, de ser así esta aumenta sus uniones .
        System.out.println("intersection");
        // Add a 'joint' to our snake
        snake.setJoints(snake.getJoints() + 1);//aumenta uniones mas uno
        // Create new food
        food.createFood();//ejecuta el metodo food
        pointy.subirPuntaje();//aumenta el puntaje
    }
}
